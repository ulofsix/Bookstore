...
$query = "SELECT * FROM products, type_list WHERE products.P_type_id= type_list.P_type_id";
...
<head>
    ...
    <link rel="stylesheet" href="../../main_flex-2.css">
...
<body>
    ...
    <div id="header">
        <div id="logo">
            ...
            <a href="../../index.html" target="_top" title="回首頁">南波灣書局</a>
        </div>
        <div id="user_list">
    ...
    <div id="content">
        <div id="main">
            <div><a href="../../index.html">　　南波灣書局</a>><a href=""><?php echo $data['P_type_name']; ?></a>>商品介紹</div>

            <div class="productBook">

                <!-- 書本資料 -->
                <div class="picture"><img src="../../images/book/book01_1.jpg"></div>
                ...
                <center>
                    <div class="shoppingCart">
                        <div><img src="../../images/shopping_cart.png"> <br>
                            庫存><span>10</span></div>
                        <input class="cartButton1" type="submit" value="放入購物車">
