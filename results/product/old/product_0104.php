...
$query = sprintf("SELECT * FROM products, type_list WHERE products.P_type_id= type_list.P_type_id",$P_ID);
...
<body>
    ...
    <div id="content">
        <div id="main">
            <div><a href="../../index.html">　　南波灣書局</a>><a href="">{P_type_name}</a>>商品介紹</div>
