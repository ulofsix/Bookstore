...
(22, '1', 2886, 10, '2021-02-05 08:26:59'),
(24, '1', 104256, 8, '2021-01-28 01:23:40');
...
--
ALTER TABLE `order_input_data`
  MODIFY `O_data_ID` int(20) NOT NULL AUTO_INCREMENT COMMENT '貨品流水編號', AUTO_INCREMENT=13;
...
--
ALTER TABLE `products`
  MODIFY `P_ID` int(20) NOT NULL AUTO_INCREMENT COMMENT '商品編號', AUTO_INCREMENT=104257;
